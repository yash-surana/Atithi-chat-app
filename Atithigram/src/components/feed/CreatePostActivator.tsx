...
const CreatePostActivator: FC<CreatePostActivatorprops> = ({ image }) => {
  ...
  return (
    <div
      className="relative mb-6 border border-[#e8e8e8] bg-white cursor-text rounded-xl shadow-none max-w-full text-[#4a4a4a]"
        ...
        <div className="p-4 border border-[#e8e8e8]">
          <div className="flex justify-start items-center">
            ...
            <div className="ml-12 bg-[#f7f7f7] rounded-md border border-[#e8e8e8]  w-full clear-both  relative sm:ml-4">
              <h3 className="text-[.9rem] mt-[13px] mb-[51px] ml-[18px] mr-[9px] ">
                Share your love vibes and celebration jives 💖
              </h3>
            </div>
          </div>
        </div>
