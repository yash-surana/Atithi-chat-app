...
async function CreatePostOuterBox() {
  ...
  return (
    <div id='createPost' className=' overflow-auto hidden justify-center items-center opacity-100 fixed h-full w-full top-0 right-0 left-0 bottom-0 m-auto z-50' style={{background:"rgba(0,0,0,.6)",marginTop:"12%"}}>
        <div className="p-4 rounded-md bg-white relative m-auto max-w-[95%] w-auto md:w-[60%] min-h-[75%] " >
            <div className="flex w-full p-3 relative border-b border-b-borderE3" style={{marginTop:"12%"}}>
