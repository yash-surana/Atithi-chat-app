  ...
  return (
    <div className=' block shrink grow basis-0 p-3 mt-4 '>
      <div className="w-full bg-white border border-gray-300 rounded-lg p-6 text-center relative ">
        ...
        <h3 className="font-semibold text-base py-2 font-montserrat">Vendor</h3>
        <p className="text-gray-500 text-sm">
        Share your designs effortlessly and collaborate with your team in real-time. Access, plan, and innovate together!
        </p>
  ...
  return (
    <div className=' block shrink grow basis-0 p-3 mt-4 '>
      <div className="w-full bg-white border border-gray-300 rounded-lg p-6 text-center relative">
        ...
        <h3 className="font-semibold text-base py-2 font-montserrat">Couple/Guests</h3>
        <p className="text-gray-500 text-sm">
        Plan your designs and share your wedding stories and photos to create lasting memories.
        </p>
        <AccountTypeSubmitBtn value={1}/>
