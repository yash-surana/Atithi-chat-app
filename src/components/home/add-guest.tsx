...
const GuestUpload: React.FC<GuestUploadProps> = ({ eventId, onClose, loggedUser, handleFormNext }) => {
  ...
  return (
    <div className="px-2 py-6 md:p-6">
      <Dialog.Title className="text-xl mb-4 flex flex-row justify-between items-end" style={{ color: 'black' }}>
      ...
      <p className="mb-4">The file should be in a specific template. Please <a className="underline italic text-red-500 cursor-pointer" onClick={() => downloadTemplate("guests")}>download our template</a> and ensure that the template matches.</p>
      <div className="mb-4">
